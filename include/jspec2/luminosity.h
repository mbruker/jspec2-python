...
public:
    ...
    bool use_ion_emit() const {return use_ion_emit_;}
    double bet_x_star(int i) const {return beam.at(i).bet_x_star;}
    double bet_y_star(int i) const {return beam.at(i).bet_y_star;}
    double bet_x_max(int i) const {return beam.at(i).bet_x_max;}
    double bet_y_max(int i) const {return beam.at(i).bet_y_max;}
